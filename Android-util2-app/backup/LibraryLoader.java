public class LibraryLoader {
    ...
    public static String getNativeLibraryDir(Context var0) {
        ...
        return var1 >= 9?var0.getApplicationInfo().nativeLibraryDir:(var1 >= 4?var0.getApplicationInfo().dataDir + "/lib":"/data/data/" + var0.getPackageName() + "/lib");
    }

    public static void loadLibrary(Context var0, String var1) {
